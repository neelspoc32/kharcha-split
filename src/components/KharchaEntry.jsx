...
export default function KharchaEntry({ entry, index, handleEntryChange, tabNewEntry, handleTagNameSanitize, setIsTagListVisible,setFocusedEntryIndex }) {
  // function onChange(e) {
    ...
    <>
      <div className="pt-4">
        <input
          ...
          onBlur={() => handleTagNameSanitize(index)}
